...
def quesB2():
    ...
    plot.set_title('No of episodes VS Discounted Reward for different algo')
    figure.canvas.set_window_title('QB2.png')
    ...
    for algo in algos:
        ...
        plot.plot(episodes, rewards, colour[op], label= algos[algo])
        op+=1
        
        print()

    plot.legend(loc='lower right')
    figure.savefig('QB2.png')
    plt.show()
